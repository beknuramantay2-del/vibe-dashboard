...
<style>
  ...
  .card { background: var(--bg2); border-radius: var(--radius-lg); border: 1px solid var(--border); margin-bottom: 16px; overflow: hidden; transition: background-color 0.3s var(--ease-out), border-color 0.3s var(--ease-out); }
  ...
  .toggle-btn { padding: 8px 16px; border-radius: var(--radius-md); border: 1px solid var(--border); background: var(--bg3); color: var(--text); font-size: 13px; cursor: pointer; transition: all 0.2s var(--ease-out); }
  .toggle-btn:hover { background: var(--accent); color: #fff; border-color: var(--accent); }
  .toggle-btn:active { transform: scale(0.96); }
  .agent-card { display: flex; align-items: center; gap: 10px; padding: 10px; border-radius: var(--radius-md); background: var(--bg3); margin-bottom: 6px; transition: background-color 0.2s var(--ease-out); }
  .agent-card:hover { background: var(--border); }
  ...
  .agent-status { font-size: 11px; color: var(--green); background: rgba(34, 197, 94, 0.1); padding: 2px 8px; border-radius: 4px; }
  .source-row { display: flex; justify-content: space-between; padding: 6px 0; font-size: 13px; border-bottom: 1px solid var(--border); transition: padding-left 0.15s var(--ease-out); }
  .source-row:hover { padding-left: 4px; }
  ...
  .links a { color: var(--accent); text-decoration: none; font-weight: 500; transition: opacity 0.2s var(--ease-out); }
